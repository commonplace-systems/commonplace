defmodule Commonplace.MUD.Topics do
  ...
  def unsubscribe_room(room_uuid),
    do: Phoenix.PubSub.unsubscribe(Commonplace.PubSub, room_topic(room_uuid))
  ...
  def subscribe_player_input(player_uuid),
    do: CPPubSub.subscribe_magenta(player_input_path(player_uuid))

  def broadcast_player_input(player_uuid, line),
    do: CPPubSub.broadcast_magenta(player_input_path(player_uuid), {:input, line})
end
